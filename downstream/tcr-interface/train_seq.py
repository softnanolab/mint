...
# python train_seq.py --checkpoint_path "/data/cb/scratch/varun/esm-multimer/esm-multimer/checkpoints/650M_nofreeze_filtered_continue/epoch=0-step=180000.ckpt"